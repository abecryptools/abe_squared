...
const std::string DEFAULT_BP_PARAM_M = "BN_P254";                        
...
int main(int argc, char **argv) {
    ...
    struct secret_key_lu_ok sk;
    init_secret_key_lu_ok(N_ATTR, &sk);
    ...
    struct ciphertext_lu_ok CT_A;
    init_ciphertext_lu_ok(N_ATTR, &CT_A);
    gt_new(CT_A.C);
