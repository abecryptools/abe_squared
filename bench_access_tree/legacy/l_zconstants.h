...
#ifndef __L_ZCONSTANTS_H__
#define __L_ZCONSTANTS_H__
...
typedef enum _L_OpenABEElementType {
    L_OpenABE_NONE_TYPE = 0x00,
    L_OpenABE_ELEMENT_INT = 0xA1,
    L_OpenABE_ELEMENT_ZP = 0xB1,
    L_OpenABE_ELEMENT_G1 = 0xB2,
    L_OpenABE_ELEMENT_G2 = 0xB3,
    L_OpenABE_ELEMENT_GT = 0xB4,
    L_OpenABE_ELEMENT_ZP_t = 0xC1,
    L_OpenABE_ELEMENT_G_t = 0xC2,
    L_OpenABE_ELEMENT_POLICY = 0x7A,
    L_OpenABE_ELEMENT_ATTRIBUTES = 0x7C, // this is ATTR_SEP '|' in hex
    L_OpenABE_ELEMENT_BYTESTRING = 0x1D,
} L_OpenABEElementType;

/// @typedef    OpenABECurveID
///
/// @brief      Enumeration all the curve identifiers supported

typedef enum L_OpenABECurveID {
  L_OpenABE_NONE_ID = 0x00,
  L_OpenABE_NIST_P256_ID = 0x32,
  L_OpenABE_NIST_P384_ID = 0x5A,
  L_OpenABE_NIST_P521_ID = 0xB7,
  L_OpenABE_BN_P158_ID = 0x61,
  L_OpenABE_BN_P254_ID = 0x6F,
  L_OpenABE_BN_P256_ID = 0x73,
  L_OpenABE_KSS_508_ID = 0x3C,
  L_OpenABE_BN_P382_ID = 0xE4,
  L_OpenABE_BN_P638_ID = 0x8D
} L_OpenABECurveID;

// Data structures

typedef enum L_zGroupType {
  L_GROUP_NONE,
  L_GROUP_G1,
  L_GROUP_G2,
  L_GROUP_GT,
