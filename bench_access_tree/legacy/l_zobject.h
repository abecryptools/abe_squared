...
#ifndef openabe_L_ZObject_h
#define openabe_L_ZObject_h
...
public:
  ...
  virtual L_ZObject& operator=(const L_ZObject &rhs) { return *this; }
  virtual L_ZObject* clone() const { return NULL; } // throw an exception if not implemented
