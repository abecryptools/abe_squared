...
#ifndef __L_ZFUNCTIONINPUT_H__
#define __L_ZFUNCTIONINPUT_H__
...
class L_OpenABEFunctionInput : public L_ZObject {
protected:
...
public:
  ...
  virtual ~L_OpenABEFunctionInput() = 0;
  ...
  virtual std::string l_toString() const = 0;
  virtual std::string l_toCompactString() const = 0;
};

// perform deep copy of a function input
//std::unique_ptr<L_OpenABEFunctionInput> copyFunctionInput(const L_OpenABEFunctionInput& input);
