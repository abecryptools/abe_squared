...
#define __L_OpenABEFUNCTIONINPUT_CPP__
...
L_OpenABEFunctionInput::L_OpenABEFunctionInput() : L_ZObject(), m_Type(FUNC_INVALID_INPUT) {}
...
L_OpenABEFunctionInput::~L_OpenABEFunctionInput() {}

/*unique_ptr<L_OpenABEFunctionInput> copyFunctionInput(const L_OpenABEFunctionInput &input) {
...
unique_ptr<L_OpenABEFunctionInput> getFunctionInput(OpenABECiphertext *ciphertext) {
